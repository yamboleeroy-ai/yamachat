...
import {withYamachatSurfaceTheme} from './yamachat-surface-theme.mjs';
...
const client=withYamachatSurfaceTheme(withVoiceThemePolish(withMessageNotificationSound(withVoiceExperience(withFriendsPanelRefresh(withServerCardContext(withServerNavigation(withServerThumbnails(withActiveServerGlow(normalized)))))))));
fs.writeFileSync(path.join(root,'desktop/desktop-client.html'),client);
console.log('Generated 1.0.92 approved social client from verified desktop 1.0.81, SHA256 '+hash);
