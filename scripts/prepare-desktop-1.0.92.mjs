...
const client=withVoiceExperience(withVoiceThemePolish(withFriendsPanelRefresh(withServerCardContext(withServerNavigation(withServerThumbnails(withActiveServerGlow(normalized)))))));
