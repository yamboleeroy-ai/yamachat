...
const client=withVoiceThemePolish(withMessageNotificationSound(withVoiceExperience(withFriendsPanelRefresh(withServerCardContext(withServerNavigation(withServerThumbnails(withActiveServerGlow(normalized))))))));
