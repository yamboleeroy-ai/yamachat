...
const client=withVoiceThemePolish(withVoiceExperience(withFriendsPanelRefresh(withServerCardContext(withServerNavigation(withServerThumbnails(withActiveServerGlow(normalized)))))));
