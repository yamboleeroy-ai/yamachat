...
(()=>{
  ...
  const client=window.supabase.createClient("https://bxjvmjdppmqgbxfcowpf.supabase.co","sb_publishable_LCIW_v-MjpfTu1hHRfdxng_wvvuYSEY",{auth:{persistSession:false,autoRefreshToken:false,detectSessionInUrl:false,storageKey:'yc-password-recovery-temporary'}});
