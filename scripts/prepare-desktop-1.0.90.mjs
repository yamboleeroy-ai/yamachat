...
const client=withServerThumbnails(withActiveServerGlow(normalized));
fs.writeFileSync(path.join(root,'desktop/desktop-client.html'),client);
console.log('Generated 1.0.90 visual-only client from verified desktop 1.0.81, SHA256 '+hash);
