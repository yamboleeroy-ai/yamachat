...
const client=withServerNavigation(withServerThumbnails(withActiveServerGlow(normalized)));
fs.writeFileSync(path.join(root,'desktop/desktop-client.html'),client);
console.log('Generated 1.0.92 Work-parity client from verified desktop 1.0.81, SHA256 '+hash);
