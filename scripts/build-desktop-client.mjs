...
fs.writeFileSync(path.join(out,'desktop-client.html'),withActiveServerGlow(withAccountMessages(withPasswordRecovery(withProfileActions(fs.readFileSync(path.join(ref,'desktop-client.html'),'utf8'))))));
